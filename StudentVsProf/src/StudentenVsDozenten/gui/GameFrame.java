...
public class GameFrame extends JFrame {
    ...
    public GameFrame() {
        ...
        if (c1.start(name, password) == false) {
            int input = JOptionPane.showConfirmDialog(null, "Bitte stelle sicher, ob eine Internetverbindung zur Verfuegung steht und ob die eingegebenen Daten korrekt eingegeben worden sind.\nNeu hier? \nRegistriere dich unter: http://hochschule.indieentwickler.net/ !", "Anmeldung fehlgeschlagen", JOptionPane.DEFAULT_OPTION);
